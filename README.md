...
***Lee, J. (2024). *rnaseqExplorer: A comprehensive Shiny application for analyzing RNA sequencing data* (Version 0.1.0) [R package]. GitHub. https://github.com/jeongahblairlee/rnaseqExplorer***
